import 'package:parkit_com/models/Api/UserAccoutModels/ProfileUpdate_Model.dart';

class ProfileController {
  var Model = ProfileUpdate_Model();
  static final _controller = ProfileController._internal();
  ...
  String City_Validator(String text) {
    print("SignUp: City Validation Passed");
    this.Model.City = text;
    return "";
  }

  String Address_Validator(String text) {
    print("SignUp: City Validation Passed");
    this.Model.Address = text;
    return "";
  }
}
