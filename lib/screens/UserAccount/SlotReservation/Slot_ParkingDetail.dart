...
import 'package:parkit_com/utilities/Buttons.dart';
...
class SlotReservationDetail extends StatefulWidget {
  @override
  _SlotReservationDetail createState() => _SlotReservationDetail();
}

class _SlotReservationDetail extends State<SlotReservationDetail>
        ...
        children: <Widget>[
          Positioned(
            ...
            child: Container(
                ...
                child: Image.asset("lib/assets/images/r.jpeg")),
          ),
          Positioned(
            top: 200.0,
            child: ClipRRect(
